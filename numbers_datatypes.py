...
#
# we will be mainly working with integers or simple float number types.
...
print("Can also do roots this way")
print(4**0.5)

print("Order of Operations followed in Python")
print(2 + 10 * 10 + 3)

print("Can use parenthesis to specify orders")
print((2+10) * (10+3))
