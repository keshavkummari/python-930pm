...
print("Now let's learn about printing strings!")
...
print("Let's try to change the first letter to 'x'")
print(s[0] = 'x')
...
print("Basic Built-in String methods")
#
...
print("Here are some examples of built-in methods in strings:")
